...
describe("codex skill scenario e2e contract", () => {
  it("provides executable scenario harness", () => {
    ...
    expect(content).toContain("If you need local references, read each of these at most once: skills/ha-nova/SKILL.md, directly referenced skills/ha-nova/*.md reference files, skills/review/SKILL.md, skills/review/checks.md.");
