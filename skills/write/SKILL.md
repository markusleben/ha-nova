...
2. BP gate (`skills/ha-nova/write-safety.md`; refresh: `skills/ha-nova/best-practices.md`): fresh, or any status on a simple change -> continue; stale/missing/invalid + complex -> block.
