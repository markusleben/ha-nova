...
- Templates present (`{{` / `{%`) → https://www.home-assistant.io/docs/configuration/templating/ (functions, filters, constants — fetch once per review; the checks in `skills/review/checks.md` stay local and offline)
