...
- HACS management parity (checklist-chasing; concierge-style coverage is higher leverage). — Superseded 2026-08 by #478: maintainer-confirmed lifecycle scope, spec in `docs/archive/work/2026-08-04-hacs-lifecycle-spec.md`.
