...
- **Public PowerShell command:** use `irm https://raw.githubusercontent.com/markusleben/ha-nova/main/install.ps1 | iex`.
- **Reason:** keep the public Windows command copy/paste-simple.
