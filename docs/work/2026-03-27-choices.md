...
- **Reason**: the previous contract declared a 5-item cap but did not operationalize it early enough, which matched the live symptom of an overlong prefix-based review run.
