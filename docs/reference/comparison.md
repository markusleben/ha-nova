...
| Undo | Automatic edit backups; full-system backups | Per-config revert of the last verified update, config-snapshot restore for deletes — plus an honest statement wherever revert does *not* exist |
