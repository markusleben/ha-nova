...
|:---------|:----------------------|:-------------|:------------------------|:---------------|:----------------|:------------------------|:------------------------|:-----------------------|:-----------------|:--------------------------|:----------------|:------|
| Linux native | Ubuntu 24.04.1 LTS | Logged-in desktop session | GNOME Keyring | Supported | Maintainer-validated | Yes | Yes | Yes | Yes | Yes | 2026-06-12 | Current real-machine Hermes/Linux proof on the 0.5.0 train: fresh bundle install, doctor via service token file, locked-keyring fail-fast classification, non-interactive `setup --service hermes` with token reuse, authenticated relay call from a fresh SSH shell without an unlocked keyring, and `uninstall --yes --purge` incl. best-effort credential-store note — all over SSH/headless with the desktop keyring locked. Interactive locked/fresh-init recovery prompts remain covered by the 2026-04-18 proof. |
