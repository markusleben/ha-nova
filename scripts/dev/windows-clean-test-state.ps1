...
$paths = @(
  ...
  (Join-Path $HOME ".gemini\config\skills\ha-nova-todo"),
  (Join-Path $HOME ".gemini\config\skills\ha-nova-backup"),
  (Join-Path $HOME ".gemini\config\skills\ha-nova-updates"),
  (Join-Path $HOME ".gemini\config\skills\ha-nova-energy"),
  (Join-Path $HOME ".gemini\config\skills\ha-nova-maintenance"),
  ...
  (Join-Path $HOME ".gemini\skills\ha-nova-todo"),
  (Join-Path $HOME ".gemini\skills\ha-nova-backup"),
  (Join-Path $HOME ".gemini\skills\ha-nova-updates"),
  (Join-Path $HOME ".gemini\skills\ha-nova-energy"),
  (Join-Path $HOME ".gemini\skills\ha-nova-maintenance"),
