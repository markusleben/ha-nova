...
$paths = @(
  ...
  (Join-Path $HOME ".gemini\antigravity\skills\ha-nova"),
  (Join-Path $HOME ".gemini\antigravity\skills\ha-nova-dashboard"),
  (Join-Path $HOME ".gemini\antigravity\skills\ha-nova-organize"),
  (Join-Path $HOME ".gemini\antigravity\skills\ha-nova-history"),
  (Join-Path $HOME ".gemini\antigravity\skills\ha-nova-write"),
  (Join-Path $HOME ".gemini\antigravity\skills\ha-nova-read"),
  (Join-Path $HOME ".gemini\antigravity\skills\ha-nova-helper"),
  (Join-Path $HOME ".gemini\antigravity\skills\ha-nova-entity-discovery"),
  (Join-Path $HOME ".gemini\antigravity\skills\ha-nova-onboarding"),
  (Join-Path $HOME ".gemini\antigravity\skills\ha-nova-service-call"),
  (Join-Path $HOME ".gemini\antigravity\skills\ha-nova-review"),
  (Join-Path $HOME ".gemini\antigravity\skills\ha-nova-fallback"),
