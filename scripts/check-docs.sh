...
# ── 2. Skill count ──
# README claims "9 skill files"
echo "[2] Skill directory count (README claims 9)"
...
if (( SKILL_COUNT == 9 )); then
  ...
  fail "skills/ has ${SKILL_COUNT} directories — README says 9. Update README and diagram."
fi
