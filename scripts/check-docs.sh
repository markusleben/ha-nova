...
# ── 2. Skill count ──
# Active skill inventory expects 25 top-level skill directories
# (context skill + 24 sub-skills; camera+mqtt added 2026-07-11)
echo "[2] Skill directory count (current inventory expects 25)"
