...
# ── 2. Skill count ──
# Active skill inventory expects 16 top-level skill directories
# (context skill + 15 sub-skills; scene+todo added 2026-07-08)
echo "[2] Skill directory count (current inventory expects 16)"
...
if (( SKILL_COUNT == 16 )); then
  ...
  fail "skills/ has ${SKILL_COUNT} directories — active docs/contracts expect 16. Update README and architecture docs."
fi
