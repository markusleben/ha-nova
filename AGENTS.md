...
- Documentation governance: active product/reference/runbook docs live in root docs, `docs/reference/`, `docs/releasing.md`, `docs/work/`, `nova/DOCS.md`, and `skills/**/SKILL.md`; legacy superpowers history now lives under `docs/archive/superpowers/` and must not receive new active docs.
